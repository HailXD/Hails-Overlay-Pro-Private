...
(function(){"use strict";const Ie=window.fetch,ot=(t,o)=>{try{if(typeof GM<"u"&&typeof GM.getValue=="function")return GM.getValue(t,o);if(typeof GM_getValue=="function")return Promise.resolve(GM_getValue(t,o))}catch{}return Promise.resolve(o)},at=(t,o)=>{try{if(typeof GM<"u"&&typeof GM.setValue=="function")return GM.setValue(t,o);if(typeof GM_setValue=="function")return Promise.resolve(GM_setValue(t,o))}catch{}return Promise.resolve()};function nt(t){return new Promise((o,r)=>{try{GM_xmlhttpRequest({method:"GET",url:t,responseType:"blob",onload:a=>{a.status>=200&&a.status<300&&a.response?o(a.response):r(new Error(`GM_xhr failed: ${a.status} ${a.statusText}`))},onerror:()=>r(new Error("GM_xhr network error")),ontimeout:()=>r(new Error("GM_xhr timeout"))})}catch(a){r(a)}})}function Be(t){return new Promise((o,r)=>{const a=new FileReader;a.onload=()=>o(a.result),a.onerror=r,a.readAsDataURL(t)})}async function Fe(t){const o=await nt(t);if(!o||!String(o.type).startsWith("image/"))throw new Error("URL did not return an image blob");return await Be(o)}function rt(t){return new Promise((o,r)=>{const a=new FileReader;a.onload=()=>o(a.result),a.onerror=r,a.readAsDataURL(t)})}const Se=[[0,0,0],[60,60,60],[120,120,120],[210,210,210],[255,255,255],[96,0,24],[237,28,36],[255,127,39],[246,170,9],[249,221,59],[255,250,188],[14,185,104],[19,230,123],[135,255,94],[12,129,110],[16,174,166],[19,225,190],[96,247,242],[40,80,158],[64,147,228],[107,80,246],[153,177,251],[120,12,153],[170,56,185],[224,159,249],[203,0,122],[236,31,128],[243,141,169],[104,70,52],[149,104,42],[248,178,119]],re=[[170,170,170],[165,14,30],[250,128,114],[228,92,26],[156,132,49],[197,173,49],[232,212,95],[74,107,58],[90,148,74],[132,197,115],[15,121,159],[187,250,242],[125,199,255],[77,49,184],[74,66,132],[122,113,196],[181,174,241],[155,82,73],[209,128,120],[250,182,164],[219,164,99],[123,99,82],[156,132,107],[214,181,148],[209,128,81],[255,197,165],[109,100,63],[148,140,107],[205,197,158],[51,57,65],[109,117,141],[179,185,209]],ye={"0,0,0":"Black","60,60,60":"Dark Gray","120,120,120":"Gray","210,210,210":"Light Gray","255,255,255":"White","96,0,24":"Deep Red","237,28,36":"Red","255,127,39":"Orange","246,170,9":"Gold","249,221,59":"Yellow","255,250,188":"Light Yellow","14,185,104":"Dark Green","19,230,123":"Green","135,255,94":"Light Green","12,129,110":"Dark Teal","16,174,166":"Teal","19,225,190":"Light Teal","96,247,242":"Cyan","40,80,158":"Dark Blue","64,147,228":"Blue","107,80,246":"Indigo","153,177,251":"Light Indigo","120,12,153":"Dark Purple","170,56,185":"Purple","224,159,249":"Light Purple","203,0,122":"Dark Pink","236,31,128":"Pink","243,141,169":"Light Pink","104,70,52":"Dark Brown","149,104,42":"Brown","248,178,119":"Beige","170,170,170":"Medium Gray","165,14,30":"Dark Red","250,128,114":"Light Red","228,92,26":"Dark Orange","156,132,49":"Dark Goldenrod","197,173,49":"Goldenrod","232,212,95":"Light Goldenrod","74,107,58":"Dark Olive","90,148,74":"Olive","132,197,115":"Light Olive","15,121,159":"Dark Cyan","187,250,242":"Light Cyan","125,199,255":"Light Blue","77,49,184":"Dark Indigo","74,66,132":"Dark Slate Blue","122,113,196":"Slate Blue","181,174,241":"Light Slate Blue","155,82,73":"Dark Peach","209,128,120":"Peach","250,182,164":"Light Peach","219,164,99":"Light Brown","123,99,82":"Dark Tan","156,132,107":"Tan","214,181,148":"Light Tan","209,128,81":"Dark Beige","255,197,165":"Light Beige","109,100,63":"Dark Stone","148,140,107":"Stone","205,197,158":"Light Stone","51,57,65":"Dark Slate","109,117,141":"Slate","179,185,209":"Light Slate"},be=Se.map(([t,o,r])=>`${t},${o},${r}`),Te=[];class pe extends Map{constructor(o){super(),this.limit=o}set(o,r){if(this.size>=this.limit){const a=this.keys().next().value;this.delete(a)}return super.set(o,r)}}const Ne=unsafeWindow;function ze(){return`${Date.now().toString(36)}-${Math.random().toString(36).slice(2,10)}`}function $e(t){const o=new Set(c.overlays.map(a=>(a.name||"").toLowerCase()));if(!o.has(t.toLowerCase()))return t;let r=1;for(;o.has(`${t} (${r})`.toLowerCase());)r++;return`${t} (${r})`}function T(t,o){if(typeof OffscreenCanvas<"u")return new OffscreenCanvas(t,o);const r=document.createElement("canvas");return r.width=t,r.height=o,r}function Ae(t,o){const r=document.createElement("canvas");return r.width=t,r.height=o,r}function ue(t){return t.convertToBlob?t.convertToBlob():new Promise((o,r)=>t.toBlob(a=>a?o(a):r(new Error("toBlob failed")),"image/png"))}async function Ue(t){if(t&&typeof t.toDataURL=="function")return t.toDataURL("image/png");if(t&&typeof t.convertToBlob=="function"){const o=await t.convertToBlob();return await Be(o)}if(typeof OffscreenCanvas<"u"&&t instanceof OffscreenCanvas){const o=t.transferToImageBitmap?.();if(o){const r=Ae(t.width,t.height);return r.getContext("2d").drawImage(o,0,0),r.toDataURL("image/png")}}throw new Error("Cannot export canvas to data URL")}async function se(t){if(typeof createImageBitmap=="function")try{return await createImageBitmap(t)}catch{}return new Promise((o,r)=>{const a=URL.createObjectURL(t),n=new Image;n.onload=()=>{URL.revokeObjectURL(a),o(n)},n.onerror=i=>{URL.revokeObjectURL(a),r(i)},n.src=a})}async function it(t){const o=await se(t),a=T(o.width,o.height).getContext("2d");return a.drawImage(o,0,0),a.getImageData(0,0,o.width,o.height)}async function qe(t){if(!t.imageBase64)return null;if(t.visibleColorKeys==null)return await le(t.imageBase64);const o=t.visibleColorKeys.slice().sort().join(","),a=`${t.imageBase64.slice(0,64)+":"+t.imageBase64.length}|${o}`;if(Me.has(a))return Me.get(a);const n=await le(t.imageBase64),i=n.width,d=n.height,s=T(i,d),p=s.getContext("2d",{willReadFrequently:!0});p.drawImage(n,0,0);const h=p.getImageData(0,0,i,d),m=h.data,b=new Set(t.visibleColorKeys);for(let g=0;g<m.length;g+=4)if(m[g+3]>0){const k=`${m[g]},${m[g+1]},${m[g+2]}`;b.has(k)||(m[g+3]=0)}p.putImageData(h,0,0);const w=await(typeof createImageBitmap=="function"?createImageBitmap(s):le(await Ue(s)));return Me.set(a,w),w}function le(t){return we.has(t)?Promise.resolve(we.get(t)):new Promise((o,r)=>{const a=new Image;a.crossOrigin="anonymous",a.onload=()=>{we.set(t,a),o(a)},a.onerror=r,a.src=t})}function ge(t){try{const o=new URL(t),r=o.pathname.split("/"),a=new URLSearchParams(o.search);return{chunk1:parseInt(r[3],10),chunk2:parseInt(r[4],10),posX:parseInt(a.get("x")||"0",10),posY:parseInt(a.get("y")||"0",10)}}catch{return{chunk1:0,chunk2:0,posX:0,posY:0}}}function st(t){try{const o=new URL(t,location.href);if(o.hostname!=="backend.wplace.live"||!o.pathname.startsWith("/files/"))return null;const r=o.pathname.match(/\/(\d+)\/(\d+)\.png$/i);return r?{chunk1:parseInt(r[1],10),chunk2:parseInt(r[2],10)}:null}catch{return null}}function lt(t){try{const o=new URL(t,location.href);if(o.hostname!=="backend.wplace.live")return null;const r=o.pathname.match(/\/s0\/pixel\/(\d+)\/(\d+)$/);if(!r)return null;const a=o.searchParams;return{normalized:`https://backend.wplace.live/s0/pixel/${r[1]}/${r[2]}?x=${a.get("x")||0}&y=${a.get("y")||0}`}}catch{return null}}function We(t,o,r,a,n,i,d,s){const p=Math.max(t,n),h=Math.max(o,i),m=Math.min(t+r,n+d),b=Math.min(o+a,i+s),w=Math.max(0,m-p),g=Math.max(0,b-h);return{x:p,y:h,w,h:g}}const ee=new pe(50),xe=new Set,we=new pe(50),Me=new pe(50),me=new pe(200),ve=new pe(200);function De(t){return[t.imageBase64?t.imageBase64.slice(0,64)+":"+t.imageBase64.length:"none",t.pixelUrl||"null",t.offsetX,t.offsetY,t.opacity].join("|")}function B(){ee.clear(),we.clear(),Me.clear(),me.clear(),ve.clear()}async function ct(t,o,r){if(!t.enabled||!t.imageBase64||!t.pixelUrl||xe.has(t.id))return null;const a=De(t),n=`${t.id}|${a}|${o}|${r}`;if(ee.has(n))return ee.get(n);const i=await qe(t);if(!i)return null;const d=i.width,s=i.height;if(d>=1e3||s>=1e3)return xe.add(t.id),D(`Overlay "${t.name}" skipped: image too large (must be smaller than 1000\xD71000; got ${d}\xD7${s}).`),null;const p=ge(t.pixelUrl);if(!Number.isFinite(p.chunk1)||!Number.isFinite(p.chunk2))return null;const h=p.chunk1*1e3+p.posX+t.offsetX-o*1e3,m=p.chunk2*1e3+p.posY+t.offsetY-r*1e3,b=We(0,0,1e3,1e3,h,m,d,s);if(b.w===0||b.h===0)return ee.set(n,null),null;const g=T(1e3,1e3).getContext("2d",{willReadFrequently:!0});g.drawImage(i,h,m);const k=g.getImageData(b.x,b.y,b.w,b.h),y=c.overlayMode==="smart"||c.overlayMode==="diff"?new Uint8ClampedArray(k.data):null,f=k.data,x=t.opacity,L=255*(1-x);for(let I=0;I<f.length;I+=4)f[I+3]>0&&(c.highlightPixels?(f[I]=255,f[I+1]=0,f[I+2]=255):(f[I]=Math.round(f[I]*x+L),f[I+1]=Math.round(f[I+1]*x+L),f[I+2]=Math.round(f[I+2]*x+L)),f[I+3]=255);const S={imageData:k,dx:b.x,dy:b.y,rawData:y};return ee.set(n,S),S}async function dt(t,o,r){if(!t.enabled||!t.imageBase64||!t.pixelUrl||xe.has(t.id))return null;const a=3,n=De(t),i=`${t.id}|${n}|minify|s${a}|${o}|${r}`;if(ee.has(i))return ee.get(i);const d=await qe(t);if(!d)return null;const s=d.width,p=d.height;if(s>=1e3||p>=1e3)return xe.add(t.id),D(`Overlay "${t.name}" skipped: image too large (must be smaller than 1000\xD71000; got ${s}\xD7${p}).`),null;const h=ge(t.pixelUrl);if(!Number.isFinite(h.chunk1)||!Number.isFinite(h.chunk2))return null;const m=h.chunk1*1e3+h.posX+t.offsetX-o*1e3,b=h.chunk2*1e3+h.posY+t.offsetY-r*1e3,w=1e3*a,g=1e3*a,k=Math.round(m*a),y=Math.round(b*a),f=s*a,x=p*a,C=We(0,0,w,g,k,y,f,x);if(C.w===0||C.h===0)return ee.set(i,null),null;const S=T(w,g).getContext("2d",{willReadFrequently:!0});S.imageSmoothingEnabled=!1,S.clearRect(0,0,w,g),S.drawImage(d,0,0,s,p,k,y,f,x);const I=S.getImageData(C.x,C.y,C.w,C.h),A=I.data,O=t.opacity,K=255*(1-O),V=Math.floor(a/2),J=C.w;for(let v=0;v<A.length;v+=4){if(A[v+3]===0)continue;const $=v/4%J,R=Math.floor(v/4/J),Y=C.x+$,q=C.y+R;Y%a===V&&q%a===V?(c.highlightPixels?(A[v]=255,A[v+1]=0,A[v+2]=255):(A[v]=Math.round(A[v]*O+K),A[v+1]=Math.round(A[v+1]*O+K),A[v+2]=Math.round(A[v+2]*O+K)),A[v+3]=255):(A[v]=0,A[v+1]=0,A[v+2]=0,A[v+3]=0)}const u={imageData:I,dx:C.x,dy:C.y,scaled:!0,scale:a};return ee.set(i,u),u}async function pt(t,o){if(!o||o.length===0)return t;const r=await se(t),a=r.width,n=r.height,i=T(a,n),d=i.getContext("2d");for(const s of o)s&&d.putImageData(s.imageData,s.dx,s.dy);return d.drawImage(r,0,0),await ue(i)}async function ut(t,o){if(!o||o.length===0)return t;const r=await se(t),a=r.width,n=r.height,i=T(a,n),d=i.getContext("2d");d.drawImage(r,0,0);for(const s of o){if(!s||!s.imageData||s.imageData.width===0||s.imageData.height===0)continue;const p=T(s.imageData.width,s.imageData.height);p.getContext("2d").putImageData(s.imageData,0,0),d.drawImage(p,s.dx,s.dy)}return await ue(i)}async function gt(t,o){if(!o||o.length===0)return t;const r=await se(t),a=r.width,n=r.height,i=T(a,n),d=i.getContext("2d",{willReadFrequently:!0});d.drawImage(r,0,0);const s=d.getImageData(0,0,a,n),p=s.data,h=new Uint32Array(p.buffer);for(const m of o){if(!m||!m.rawData)continue;const b=m.rawData,w=m.imageData.data,g=m.imageData.width,k=m.imageData.height,y=new Uint32Array(b.buffer),f=new Uint32Array(w.buffer);for(let x=0;x<k;x++){const C=m.dy+x;if(!(C<0||C>=n))for(let L=0;L<g;L++){const S=m.dx+L;if(S<0||S>=a)continue;const I=(x*g+L)*4;if(b[I+3]>0){const A=C*a+S,O=x*g+L;y[O]!==h[A]&&(h[A]=f[O])}}}}return d.putImageData(s,0,0),await ue(i)}async function mt(t,o){if(!o||o.length===0)return t;const r=await se(t),a=r.width,n=r.height,i=T(a,n),d=i.getContext("2d",{willReadFrequently:!0});d.drawImage(r,0,0);const s=d.getImageData(0,0,a,n),p=s.data,h=new Uint32Array(p.buffer);for(const m of o){if(!m||!m.rawData)continue;const b=m.rawData,w=m.imageData.data,g=m.imageData.width,k=m.imageData.height,y=new Uint32Array(b.buffer),f=new Uint32Array(w.buffer);for(let x=0;x<k;x++){const C=m.dy+x;if(!(C<0||C>=n))for(let L=0;L<g;L++){const S=m.dx+L;if(S<0||S>=a)continue;const I=(x*g+L)*4;if(b[I+3]>0){const A=C*a+S,O=A,N=x*g+L;p[A*4+3]>0&&y[N]!==h[O]&&(h[O]=f[N])}}}}return d.putImageData(s,0,0),await ue(i)}async function vt(t,o){if(!o||o.length===0)return t;const r=3,a=await se(t),n=a.width,i=a.height,d=T(n*r,i*r),s=d.getContext("2d",{willReadFrequently:!0});s.imageSmoothingEnabled=!1,s.drawImage(a,0,0,n*r,i*r);for(const p of o){if(!p)continue;const h=p.imageData.width,m=p.imageData.height;if(h===0||m===0)continue;const b=T(h,m);b.getContext("2d",{willReadFrequently:!0}).putImageData(p.imageData,0,0),s.drawImage(b,p.dx,p.dy)}return await ue(d)}function D(t,o=3e3){let r=document.getElementById("op-toast-stack");r||(r=document.createElement("div"),r.className="op-toast-stack",r.id="op-toast-stack",document.body.appendChild(r)),r.classList.toggle("op-dark",c.theme==="dark");const a=document.createElement("div");a.className="op-toast",a.textContent=t,r.appendChild(a),requestAnimationFrame(()=>a.classList.add("show")),setTimeout(()=>{a.classList.remove("show"),setTimeout(()=>a.remove(),200)},o)}let ke=!1;function ht(){const t=c.overlays.some(a=>a.enabled&&a.imageBase64),o=!!c.autoCapturePixelUrl&&!!c.activeOverlayId;return(c.overlayMode==="behind"||c.overlayMode==="above"||c.overlayMode==="smart"||c.overlayMode==="diff"||c.overlayMode==="minify")&&(t||o)&&c.overlays.length>0}function H(){ht()?ft():yt()}function ft(){if(ke)return;const t=Ie,o=async(r,a)=>{const n=typeof r=="string"?r:r&&r.url||"";if(c.autoCapturePixelUrl&&c.activeOverlayId){const s=lt(n);if(s){const p=c.overlays.find(h=>h.id===c.activeOverlayId);if(p&&p.pixelUrl!==s.normalized){p.pixelUrl=s.normalized,p.offsetX=0,p.offsetY=0,await E(["overlays"]),B(),c.autoCapturePixelUrl=!1,await E(["autoCapturePixelUrl"]),P();const m=ge(p.pixelUrl);D(`Anchor set for "${p.name}": chunk ${m.chunk1}/${m.chunk2} at (${m.posX}, ${m.posY}). Offset reset to (0,0).`),H()}}}const i=st(n);if(!i||!["behind","above","smart","diff","minify"].includes(c.overlayMode))return t(r,a);try{const s=await t(r,a);if(!s.ok||!(s.headers.get("Content-Type")||"").toLowerCase().includes("image"))return s;const h=c.overlays.filter(g=>g.enabled&&g.imageBase64&&g.pixelUrl);if(h.length===0)return s;const m=await s.blob();try{const g=await it(m.slice()),k=`${i.chunk1},${i.chunk2}`;me.set(k,g)}catch(g){console.error("Hail's OP: Failed to cache tile",g)}if(m.size>15*1024*1024)return s;let b;if(c.overlayMode==="minify"){const g=[];for(const k of h)g.push(await dt(k,i.chunk1,i.chunk2));b=await vt(m,g.filter(Boolean))}else{const g=[];for(const k of h)g.push(await ct(k,i.chunk1,i.chunk2));c.overlayMode==="smart"?b=await gt(m,g.filter(Boolean)):c.overlayMode==="diff"?b=await mt(m,g.filter(Boolean)):b=await(c.overlayMode==="behind"?pt(m,g.filter(Boolean)):ut(m,g.filter(Boolean)))}const w=new Headers(s.headers);return w.set("Content-Type","image/png"),w.delete("Content-Length"),new Response(b,{status:s.status,statusText:s.statusText,headers:w})}catch(s){return console.error("Hail's OP: Error processing tile",s),t(r,a)}};Ne.fetch=o,window.fetch=o,ke=!0}function yt(){ke&&(Ne.fetch=Ie,window.fetch=Ie,ke=!1)}const c={overlays:[],activeOverlayId:null,overlayMode:"behind",isPanelCollapsed:!1,autoCapturePixelUrl:!1,panelX:null,panelY:null,theme:"light",collapseList:!1,collapseEditor:!1,collapseNudge:!1,collapseColors:!1,highlightPixels:!1,ccFreeKeys:be.slice(),ccPaidKeys:Te.slice(),ccZoom:1,ccRealtime:!1,colorSortBy:"errorCount",colorsScrollTop:0},He=Object.keys(c);async function bt(){try{await Promise.all(He.map(async t=>{c[t]=await ot(t,c[t])})),(!Array.isArray(c.ccFreeKeys)||c.ccFreeKeys.length===0)&&(c.ccFreeKeys=be.slice()),Array.isArray(c.ccPaidKeys)||(c.ccPaidKeys=Te.slice()),(!Number.isFinite(c.ccZoom)||c.ccZoom<=0)&&(c.ccZoom=1),typeof c.ccRealtime!="boolean"&&(c.ccRealtime=!1)}catch(t){console.error("Hail's OP: Failed to load config",t)}}async function E(t=He){try{await Promise.all(t.map(o=>at(o,c[o])))}catch(o){console.error("Hail's OP: Failed to save config",o)}}function xt(){const t=document.createElement("style");t.textContent=`
      body.op-theme-light {
        --op-bg: #f7f9fc;
        --op-border: #e1e8f2;
        --op-muted: #6b7280;
    ...
    `,document.body.appendChild(t),Dt(),Yt(),It(),St(t),P()}function X(){return c.overlays.find(t=>t.id===c.activeOverlayId)||null}function Ve(){const t=document.getElementById("op-overlay-list");if(t){t.innerHTML="";for(const o of c.overlays){const r=document.createElement("div");r.className="op-item"+(o.id===c.activeOverlayId?" active":"");const a=o.isLocal?" (local)":o.imageBase64?"":" (no image)";r.innerHTML=`
      ...
      `;const[n,i,d,s]=r.children;n.addEventListener("change",async()=>{const p=c.activeOverlayId!==o.id;c.activeOverlayId=o.id,await E(["activeOverlayId"]),P(),p&&await j()}),i.addEventListener("change",()=>{o.enabled=i.checked,E(["overlays"]),B(),H()}),d.addEventListener("click",async()=>{const p=c.activeOverlayId!==o.id;c.activeOverlayId=o.id,await E(["activeOverlayId"]),P(),p&&await j()}),s.addEventListener("click",async p=>{if(p.stopPropagation(),!confirm(`Delete overlay "${o.name||"(unnamed)"}"?`))return;const h=c.overlays.findIndex(m=>m.id===o.id);if(h>=0){const m=c.activeOverlayId===o.id;c.overlays.splice(h,1),m&&(c.activeOverlayId=c.overlays[0]?.id||null),await E(["overlays","activeOverlayId"]),B(),H(),P(),m&&await j()}}),t.appendChild(r)}}}async function Mt(){const t=$e("Overlay"),o={id:ze(),name:t,enabled:!0,imageUrl:null,imageBase64:null,isLocal:!1,pixelUrl:null,offsetX:0,offsetY:0,opacity:.7,visibleColorKeys:[]};return c.overlays.push(o),c.activeOverlayId=o.id,await E(["overlays","activeOverlayId"]),B(),H(),P(),await j(),o}async function kt(t,o){const r=await Fe(o);t.imageUrl=o,t.imageBase64=r,t.isLocal=!1,await E(["overlays"]),B(),c.autoCapturePixelUrl=!0,await E(["autoCapturePixelUrl"]),H(),P(),await j(),D("Image loaded. Placement mode ON -- click once to set anchor.")}async function Ke(t,o){if(!o||!o.type||!o.type.startsWith("image/")){alert("Please choose an image file.");return}if(!confirm("Local PNGs cannot be exported to friends! Are you sure?"))return;const r=await rt(o);t.imageBase64=r,t.imageUrl=null,t.isLocal=!0,await E(["overlays"]),B(),c.autoCapturePixelUrl=!0,await E(["autoCapturePixelUrl"]),H(),P(),await j(),D("Local image loaded. Placement mode ON -- click once to set anchor.")}async function Et(t){let o;try{o=JSON.parse(t)}catch{alert("Invalid JSON");return}const r=Array.isArray(o)?o:[o];let a=0,n=0;for(const i of r){const d=$e(i.name||"Imported Overlay"),s=i.imageUrl,p=i.pixelUrl??null,h=Number.isFinite(i.offsetX)?i.offsetX:0,m=Number.isFinite(i.offsetY)?i.offsetY:0,b=Number.isFinite(i.opacity)?i.opacity:.7;if(!s){n++;continue}try{const w=await Fe(s),g={id:ze(),name:d,enabled:!0,imageUrl:s,imageBase64:w,isLocal:!1,pixelUrl:p,offsetX:h,offsetY:m,opacity:b,visibleColorKeys:[]};c.overlays.push(g),a++}catch(w){console.error("Import failed for",s,w),n++}}a>0&&(c.activeOverlayId=c.overlays[c.overlays.length-1].id,await E(["overlays","activeOverlayId"]),B(),H(),P(),await j()),alert(`Import finished. Imported: ${a}${n?`, Failed: ${n}`:""}`)}function Ct(){const t=X();if(!t){alert("No active overlay selected.");return}if(t.isLocal||!t.imageUrl){alert("This overlay uses a local image and cannot be exported. Please host the image and set an image URL.");return}const o={version:1,name:t.name,imageUrl:t.imageUrl,pixelUrl:t.pixelUrl??null,offsetX:t.offsetX,offsetY:t.offsetY,opacity:t.opacity},r=JSON.stringify(o,null,2);Re(r).then(()=>alert("Overlay JSON copied to clipboard!")).catch(()=>{prompt("Copy the JSON below:",r)})}function Re(t){return navigator.clipboard&&navigator.clipboard.writeText?navigator.clipboard.writeText(t):Promise.reject(new Error("Clipboard API not available"))}let Ge;function Lt(){clearTimeout(Ge),Ge=setTimeout(()=>{E(["colorsScrollTop"])},250)}function It(){const t=n=>document.getElementById(n);t("op-theme-toggle").addEventListener("click",async n=>{n.stopPropagation(),c.theme=c.theme==="light"?"dark":"light",await E(["theme"]),Oe()}),t("op-refresh-btn").addEventListener("click",n=>{n.stopPropagation(),location.reload()}),t("op-mode-select").addEventListener("change",n=>{c.overlayMode=n.target.value,E(["overlayMode"]),H(),P()}),t("op-autocap-toggle").addEventListener("click",()=>{c.autoCapturePixelUrl=!c.autoCapturePixelUrl,E(["autoCapturePixelUrl"]),H(),P()}),t("op-highlight-toggle").addEventListener("change",async n=>{c.highlightPixels=n.target.checked,await E(["highlightPixels"]),B()}),t("op-add-overlay").addEventListener("click",async()=>{try{await Mt()}catch(n){console.error(n)}}),t("op-import-overlay").addEventListener("click",async()=>{const n=prompt("Paste overlay JSON (single or array):");n&&await Et(n)}),t("op-export-overlay").addEventListener("click",()=>Ct()),t("op-collapse-list").addEventListener("click",()=>{c.collapseList=!c.collapseList,E(["collapseList"]),P()}),t("op-collapse-editor").addEventListener("click",()=>{c.collapseEditor=!c.collapseEditor,E(["collapseEditor"]),P()}),t("op-collapse-nudge").addEventListener("click",()=>{c.collapseNudge=!c.collapseNudge,E(["collapseNudge"]),P()}),t("op-collapse-colors").addEventListener("click",()=>{c.collapseColors=!c.collapseColors,E(["collapseColors"]),P()}),t("op-colors-refresh").addEventListener("click",async()=>{ve.clear(),await j()}),t("op-color-sort-select").addEventListener("change",async n=>{c.colorSortBy=n.target.value,await E(["colorSortBy"]),await j(!1)}),t("op-colors-all").addEventListener("click",async()=>{const n=X();if(!n)return;n.visibleColorKeys=null,await E(["overlays"]),B(),document.getElementById("op-colors-list").querySelectorAll('input[type="checkbox"]').forEach(d=>{d.checked=!0})}),t("op-colors-none").addEventListener("click",async()=>{const n=X();if(!n)return;n.visibleColorKeys=[],await E(["overlays"]),B(),document.getElementById("op-colors-list").querySelectorAll('input[type="checkbox"]').forEach(d=>{d.checked=!1})}),t("op-colors-free").addEventListener("click",async()=>{const n=X();if(!n)return;const i=Z.map(p=>p.key),d=new Set(Se.map(([p,h,m])=>`${p},${h},${m}`));n.visibleColorKeys=i.filter(p=>d.has(p)),await E(["overlays"]),B(),document.getElementById("op-colors-list").querySelectorAll('input[type="checkbox"]').forEach(p=>{p.checked=d.has(p.dataset.key)})}),t("op-colors-paid").addEventListener("click",async()=>{const n=X();if(!n)return;const i=Z.map(p=>p.key),d=new Set(re.map(([p,h,m])=>`${p},${h},${m}`));n.visibleColorKeys=i.filter(p=>d.has(p)),await E(["overlays"]),B(),document.getElementById("op-colors-list").querySelectorAll('input[type="checkbox"]').forEach(p=>{p.checked=d.has(p.dataset.key)})}),t("op-colors-copy").addEventListener("click",()=>{if(!X())return;const i="Color,type,wrongEmpty,wrongDiff,wrong,correct,total";if(!Z||Z.length===0){Re(i).then(()=>D("No color data to copy.")).catch(()=>D("Failed to copy."));return}const d=new Set(re.map(([h,m,b])=>`${h},${m},${b}`)),s=Z.map(h=>{const{key:m,name:b,totalCount:w,belowCount:g,smartCount:k,errorCount:y,correctCount:f}=h,x=d.has(m)?"P":"F";return`${b},${x},${g},${k},${y},${f},${w}`}),p=[i,...s].join(`
`);Re(p).then(()=>D("Color data copied to clipboard!")).catch(()=>D("Failed to copy color data."))}),t("op-name").addEventListener("change",async n=>{const i=X();if(!i)return;const d=(n.target.value||"").trim()||"Overlay";c.overlays.some(s=>s.id!==i.id&&(s.name||"").toLowerCase()===d.toLowerCase())?(i.name=$e(d),D(`Name in use. Renamed to "${i.name}".`)):i.name=d,await E(["overlays"]),Ve()}),t("op-fetch").addEventListener("click",async()=>{const n=X();if(!n){alert("No active overlay selected.");return}if(n.imageBase64){alert("This overlay already has an image. Create a new overlay to change the image.");return}const i=t("op-image-url").value.trim();if(!i){alert("Enter an image link first.");return}try{await kt(n,i)}catch(d){console.error(d),alert("Failed to fetch image.")}});const o=t("op-dropzone");o.addEventListener("click",()=>t("op-file-input").click()),t("op-file-input").addEventListener("change",async n=>{const i=n.target.files&&n.target.files[0];if(n.target.value="",!i)return;const d=X();if(d){if(d.imageBase64){alert("This overlay already has an image. Create a new overlay to change the image.");return}try{await Ke(d,i)}catch(s){console.error(s),alert("Failed to load local image.")}}}),["dragenter","dragover"].forEach(n=>o.addEventListener(n,i=>{i.preventDefault(),i.stopPropagation(),o.classList.add("drop-highlight")})),["dragleave","drop"].forEach(n=>o.addEventListener(n,i=>{i.preventDefault(),i.stopPropagation(),!(n==="dragleave"&&i.target!==o)&&o.classList.remove("drop-highlight")})),o.addEventListener("drop",async n=>{const i=n.dataTransfer;if(!i)return;const d=i.files&&i.files[0];if(!d)return;const s=X();if(s){if(s.imageBase64){alert("This overlay already has an image. Create a new overlay to change the image.");return}try{await Ke(s,d)}catch(p){console.error(p),alert("Failed to load dropped image.")}}});const r=async(n,i)=>{const d=X();d&&(d.offsetX+=n,d.offsetY+=i,await E(["overlays"]),B(),P())};t("op-nudge-up").addEventListener("click",()=>r(0,-1)),t("op-nudge-down").addEventListener("click",()=>r(0,1)),t("op-nudge-left").addEventListener("click",()=>r(-1,0)),t("op-nudge-right").addEventListener("click",()=>r(1,0)),t("op-opacity-slider").addEventListener("input",n=>{const i=X();i&&(i.opacity=parseFloat(n.target.value),document.getElementById("op-opacity-value").textContent=Math.round(i.opacity*100)+"%")}),t("op-opacity-slider").addEventListener("change",async()=>{await E(["overlays"]),B()}),t("op-download-overlay").addEventListener("click",()=>{const n=X();if(!n||!n.imageBase64){D("No overlay image to download.");return}const i=document.createElement("a");i.href=n.imageBase64,i.download=`${(n.name||"overlay").replace(/[^\w.-]+/g,"_")}.png`,document.body.appendChild(i),i.click(),i.remove()}),t("op-open-cc").addEventListener("click",()=>{const n=X();if(!n||!n.imageBase64){D("No overlay image to edit.");return}Rt(n)});const a=t("op-open-resize");a&&a.addEventListener("click",()=>{const n=X();if(!n||!n.imageBase64){D("No overlay image to resize.");return}Pt(n)}),window.addEventListener("resize",()=>{}),t("op-colors-list").addEventListener("scroll",()=>{const n=t("op-colors-list");n&&(c.colorsScrollTop=n.scrollTop,Lt())})}function St(t){const o=t.querySelector("#op-header"),r=t.querySelector("#op-panel-toggle");if(!o||!r)return;let a=!1,n=0,i=0,d=0,s=0,p=!1;const h=(g,k,y)=>Math.min(Math.max(g,k),y),m=g=>{const k=t.classList.contains("collapsed"),y=k?r:o;if(k){if(g.target!==r)return}else if(!g.target.closest("#op-header")||g.target.closest("button"))return;a=!0,p=!1,n=g.clientX,i=g.clientY;const f=t.getBoundingClientRect();d=f.left,s=f.top,y.setPointerCapture?.(g.pointerId),g.preventDefault()},b=g=>{if(!a)return;const k=g.clientX-n,y=g.clientY-i,f=Math.max(8,window.innerWidth-t.offsetWidth-8),x=Math.max(8,window.innerHeight-t.offsetHeight-8);t.style.left=h(d+k,8,f)+"px",t.style.top=h(s+y,8,x)+"px",p=!0},w=g=>{if(!a)return;const y=t.classList.contains("collapsed")?r:o;a=!1,y.releasePointerCapture?.(g.pointerId),p&&(c.panelX=parseInt(t.style.left,10)||0,c.panelY=parseInt(t.style.top,10)||0,E(["panelX","panelY"]))};t.addEventListener("pointerdown",m),t.addEventListener("pointermove",b),t.addEventListener("pointerup",w),t.addEventListener("pointercancel",w),window.addEventListener("resize",()=>{const g=t.getBoundingClientRect(),k=Math.max(8,window.innerWidth-t.offsetWidth-8),y=Math.max(8,window.innerHeight-t.offsetHeight-8),f=Math.min(Math.max(g.left,8),k),x=Math.min(Math.max(g.top,8),y);t.style.left=f+"px",t.style.top=x+"px",c.panelX=f,c.panelY=x,E(["panelX","panelY"])}),r.addEventListener("click",g=>{if(p){g.preventDefault(),g.stopPropagation();return}c.isPanelCollapsed=!c.isPanelCollapsed,E(["isPanelCollapsed"]),P()})}function Oe(){document.body.classList.toggle("op-theme-dark",c.theme==="dark"),document.body.classList.toggle("op-theme-light",c.theme!=="dark");const t=document.getElementById("op-toast-stack");t&&t.classList.toggle("op-dark",c.theme==="dark")}function $t(){const t=b=>document.getElementById(b),o=X(),r=t("op-editor-section"),a=t("op-editor-body");if(r.style.display=o?"flex":"none",!o)return;t("op-name").value=o.name||"";const n=t("op-image-source"),i=t("op-preview-wrap"),d=t("op-image-preview"),s=t("op-cc-btn-row");o.imageBase64?(n.style.display="none",i.style.display="flex",d.src=o.imageBase64,s.style.display="flex"):(n.style.display="block",i.style.display="none",s.style.display="none",t("op-image-url").value=o.imageUrl||"");const p=o.pixelUrl?ge(o.pixelUrl):{chunk1:"-",chunk2:"-",posX:"-",posY:"-"};t("op-coord-display").textContent=o.pixelUrl?`Ref: chunk ${p.chunk1}/${p.chunk2} at (${p.posX}, ${p.posY})`:'No pixel anchor set. Turn ON "Place overlay" and click a pixel once.',t("op-opacity-slider").value=String(o.opacity),t("op-opacity-value").textContent=Math.round(o.opacity*100)+"%";const h=document.getElementById("op-offset-indicator");h&&(h.textContent=`Offset X ${o.offsetX}, Y ${o.offsetY}`),a.style.display=c.collapseEditor?"none":"block";const m=document.getElementById("op-collapse-editor");m&&(m.textContent=c.collapseEditor?"\u25B8":"\u25BE")}async function P(){const t=S=>document.getElementById(S),o=t("overlay-pro-panel");if(!o)return;Oe();const r=t("op-content"),a=t("op-panel-toggle"),n=t("op-header"),i=!!c.isPanelCollapsed;o.classList.toggle("collapsed",i),r.style.display=i?"none":"grid",a.classList.toggle("logo-button",i),a.title=i?"Expand":"Collapse";const d=t("op-mode-select");d&&(d.value=c.overlayMode);const s=t("op-autocap-toggle"),p=t("op-place-label");s.textContent=c.autoCapturePixelUrl?"ON":"OFF",s.classList.toggle("op-danger",!!c.autoCapturePixelUrl),p.classList.toggle("op-danger-text",!!c.autoCapturePixelUrl);const h=t("op-highlight-toggle");h&&(h.checked=!!c.highlightPixels);const m=t("op-list-wrap"),b=t("op-collapse-list");m.style.display=c.collapseList?"none":"block",b&&(b.textContent=c.collapseList?"\u25B8":"\u25BE");const w=t("op-nudge-body"),g=t("op-collapse-nudge");w.style.display=c.collapseNudge?"none":"block",g&&(g.textContent=c.collapseNudge?"\u25B8":"\u25BE");const k=t("op-colors-body"),y=t("op-collapse-colors");k&&(k.style.display=c.collapseColors?"none":"block"),y&&(y.textContent=c.collapseColors?"\u25B8":"\u25BE");const f=t("op-color-sort-select");f&&(f.value=c.colorSortBy||"errorCount"),Ve(),$t();const x=t("op-export-overlay"),C=X(),L=!!(C&&C.imageUrl&&!C.isLocal);x.disabled=!L,x.title=L?"Export active overlay JSON":"Export disabled for local images"}const _e=new Map;let Z=[];async function Ze(t){if(!t||!t.imageBase64)return{};const o=t.imageBase64.slice(0,64)+":"+t.imageBase64.length;if(_e.has(o))return _e.get(o);const r=await le(t.imageBase64),n=T(r.width,r.height).getContext("2d",{willReadFrequently:!0});n.drawImage(r,0,0);const d=n.getImageData(0,0,r.width,r.height).data,s={};for(let p=0;p<d.length;p+=4)if(d[p+3]>0){const h=`${d[p]},${d[p+1]},${d[p+2]}`;s[h]=(s[h]||0)+1}return _e.set(o,s),s}async function At(t){if(!t||!t.imageBase64||!t.pixelUrl)return null;const o=De(t),r=Array.from(me.keys()).sort().join(";"),a=`${t.id}|${o}|${r}`;if(ve.has(a))return ve.get(a);const n=await le(t.imageBase64),i=n.width,d=n.height,p=T(i,d).getContext("2d",{willReadFrequently:!0});p.drawImage(n,0,0);const m=p.getImageData(0,0,i,d).data,b=ge(t.pixelUrl);if(!Number.isFinite(b.chunk1)||!Number.isFinite(b.chunk2))return null;const w={};for(let g=0;g<d;g++)for(let k=0;k<i;k++){const y=(g*i+k)*4;if(m[y+3]===0)continue;const f=m[y],x=m[y+1],C=m[y+2],L=`${f},${x},${C}`;w[L]||(w[L]={smart:0,below:0});const S=b.chunk1*1e3+b.posX+t.offsetX+k,I=b.chunk2*1e3+b.posY+t.offsetY+g,A=Math.floor(S/1e3),O=Math.floor(I/1e3),N=`${A},${O}`;if(me.has(N)){const K=me.get(N),V=K.data,J=K.width,u=(S%1e3+1e3)%1e3,M=((I%1e3+1e3)%1e3*J+u)*4,$=V[M],R=V[M+1],Y=V[M+2];V[M+3]===0?w[L].below++:(f!==$||x!==R||C!==Y)&&w[L].smart++}}return ve.set(a,w),w}async function j(t=!0){const o=X(),r=document.getElementById("op-colors-section");if(!r)return;if(!o||!o.imageBase64){r.style.display="none",Z=[];return}r.style.display="flex";const a=document.getElementById("op-colors-list");let n;if(t||!Z||Z.length===0){a.innerHTML='<div class="op-muted" style="text-align:center; padding: 12px 0;">Loading...</div>';const y=await Ze(o),f=await At(o)||{};n=Object.entries(y).map(([x,C])=>{const L=f[x]?.below||0,S=f[x]?.smart||0,I=L+S,A=C-I;return{key:x,name:ye[x]||x,totalCount:C,belowCount:L,smartCount:S,errorCount:I,correctCount:A}}),Z=n}else n=Z;const i=c.colorSortBy||"errorCount";n=[...n].sort((y,f)=>f[i]===y[i]?f.totalCount-y.totalCount:f[i]-y[i]);let s;o.visibleColorKeys===null||o.visibleColorKeys===void 0?s=new Set(n.map(y=>y.key)):s=new Set(o.visibleColorKeys);const p=n.reduce((y,f)=>y+f.correctCount,0),h=n.reduce((y,f)=>y+f.errorCount,0),m=n.reduce((y,f)=>y+f.totalCount,0),b=document.getElementById("op-total-correct"),w=document.getElementById("op-total-wrong"),g=document.getElementById("op-total-pixels");b&&(b.textContent=p.toLocaleString()),w&&(w.textContent=h.toLocaleString()),g&&(g.textContent=m.toLocaleString());const k=new Set(re.map(([y,f,x])=>`${y},${f},${x}`));if(a.innerHTML="",n.length===0){a.innerHTML='<div class="op-muted" style="text-align:center; padding: 12px 0;">No colors found.</div>';return}for(const y of n){const{key:f,name:x,totalCount:C,belowCount:L,smartCount:S,errorCount:I,correctCount:A}=y,O=k.has(f),N=document.createElement("div");N.className="op-dist-item"+(O?" premium":""),N.title=`${x} (${f}): ${C} pixels`;const K=`<span style="color: lime;">${A}</span>/<span style="color: cyan;">${L}</span>/<span style="color: pink;">${S}</span>/<span style="color: red;">${I}</span>/${C}`;N.innerHTML=`
        ...
        `,a.appendChild(N)}a.querySelectorAll('input[type="checkbox"]').forEach(y=>{y.addEventListener("change",async()=>{const f=y.dataset.key,x=X();if(!x)return;if(x.visibleColorKeys===null){const L=Object.keys(await Ze(x));x.visibleColorKeys=L}const C=new Set(x.visibleColorKeys);y.checked?C.add(f):C.delete(f),x.visibleColorKeys=Array.from(C),await E(["overlays"]),B()})}),Number.isFinite(c.colorsScrollTop)&&(a.scrollTop=c.colorsScrollTop)}let l=null;function Dt(){const t=document.createElement("div");t.className="op-cc-backdrop",t.id="op-cc-backdrop",document.body.appendChild(t);const o=document.createElement("div");o.className="op-cc-modal",o.id="op-cc-modal",o.style.display="none",o.innerHTML=`
    ...
    `,document.body.appendChild(o),o.querySelector("#op-cc-close").addEventListener("click",Ee),t.addEventListener("click",Ee),o.querySelector("#op-cc-cancel").addEventListener("click",Ee),l={backdrop:t,modal:o,previewCanvas:o.querySelector("#op-cc-preview"),previewCtx:o.querySelector("#op-cc-preview").getContext("2d",{willReadFrequently:!0}),sourceCanvas:null,sourceCtx:null,sourceImageData:null,processedCanvas:null,processedCtx:null,freeGrid:o.querySelector("#op-cc-free-grid"),paidGrid:o.querySelector("#op-cc-paid-grid"),freeToggle:o.querySelector("#op-cc-free-toggle"),paidToggle:o.querySelector("#op-cc-paid-toggle"),meta:o.querySelector("#op-cc-meta"),applyBtn:o.querySelector("#op-cc-apply"),recalcBtn:o.querySelector("#op-cc-recalc"),realtimeBtn:o.querySelector("#op-cc-realtime"),zoom:1,selectedFree:new Set(c.ccFreeKeys),selectedPaid:new Set(c.ccPaidKeys),realtime:!!c.ccRealtime,overlay:null,lastColorCounts:{},isStale:!1},l.realtimeBtn.addEventListener("click",async()=>{l.realtime=!l.realtime,l.realtimeBtn.textContent=`Realtime: ${l.realtime?"ON":"OFF"}`,l.realtimeBtn.classList.toggle("op-danger",l.realtime),c.ccRealtime=l.realtime,await E(["ccRealtime"]),l.realtime&&l.isStale&&i()});const r=async()=>{l.zoom=Math.min(8,(l.zoom||1)*1.25),c.ccZoom=l.zoom,await E(["ccZoom"]),te(),oe()},a=async()=>{l.zoom=Math.max(.1,(l.zoom||1)/1.25),c.ccZoom=l.zoom,await E(["ccZoom"]),te(),oe()};o.querySelector("#op-cc-zoom-in").addEventListener("click",r),o.querySelector("#op-cc-zoom-out").addEventListener("click",a),l.recalcBtn.addEventListener("click",()=>{i()}),l.applyBtn.addEventListener("click",async()=>{const d=l.overlay;if(!d)return;if(je().length===0){D("Select at least one color.");return}if(l.isStale&&i(),!l.processedCanvas){D("Nothing to apply.");return}if(l.processedCanvas.width>=1e3||l.processedCanvas.height>=1e3){D("Image too large to apply (must be < 1000\xD71000).");return}const p=l.processedCanvas.toDataURL("image/png");d.imageBase64=p,d.imageUrl=null,d.isLocal=!0,await E(["overlays"]),B(),H(),P();const h=Object.keys(l.lastColorCounts).length;D(`Overlay updated (${l.processedCanvas.width}\xD7${l.processedCanvas.height}, ${h} colors).`),Ee()}),_t(),l.freeToggle.addEventListener("click",async()=>{const d=Qe();tt("free",!d),c.ccFreeKeys=Array.from(l.selectedFree),await E(["ccFreeKeys"]),l.realtime?i():n(),te(),oe(),he()}),l.paidToggle.addEventListener("click",async()=>{const d=et();tt("paid",!d),c.ccPaidKeys=Array.from(l.selectedPaid),await E(["ccPaidKeys"]),l.realtime?i():n(),te(),oe(),he()});function n(){l.isStale=!0,l.meta.textContent=l.meta.textContent.replace(/ \| Status: .+$/,"")+" | Status: pending recalculation"}function i(){Ce(),l.isStale=!1,te(),oe(),Je()}}function Rt(t){if(!l)return;l.overlay=t,document.body.classList.add("op-scroll-lock"),l.zoom=Number(c.ccZoom)||1,l.realtime=!!c.ccRealtime,l.realtimeBtn.textContent=`Realtime: ${l.realtime?"ON":"OFF"}`,l.realtimeBtn.classList.toggle("op-danger",l.realtime);const o=new Image;o.onload=()=>{l.sourceCanvas||(l.sourceCanvas=document.createElement("canvas"),l.sourceCtx=l.sourceCanvas.getContext("2d",{willReadFrequently:!0})),l.sourceCanvas.width=o.width,l.sourceCanvas.height=o.height,l.sourceCtx.clearRect(0,0,o.width,o.height),l.sourceCtx.drawImage(o,0,0),l.sourceImageData=l.sourceCtx.getImageData(0,0,o.width,o.height),l.processedCanvas||(l.processedCanvas=document.createElement("canvas"),l.processedCtx=l.processedCanvas.getContext("2d")),Ce(),l.isStale=!1,te(),oe(),Je(),l.backdrop.classList.add("show"),l.modal.style.display="flex"},o.src=t.imageBase64}function Ee(){l&&(l.backdrop.classList.remove("show"),l.modal.style.display="none",l.overlay=null,document.body.classList.remove("op-scroll-lock"))}function Ot(t,o,r,a){let n=null,i=1/0;for(let d=0;d<a.length;d++){const[s,p,h]=a[d],m=(s+t)/2,b=s-t,w=p-o,g=h-r,k=(512+m)*b*b>>8,y=4*w*w,f=(767-m)*g*g>>8,x=k+y+f;x<i&&(i=x,n=[s,p,h])}return n||[0,0,0]}function je(){const t=[];return l.selectedFree.forEach(o=>{const[r,a,n]=o.split(",").map(i=>parseInt(i,10));Number.isFinite(r)&&t.push([r,a,n])}),l.selectedPaid.forEach(o=>{const[r,a,n]=o.split(",").map(i=>parseInt(i,10));Number.isFinite(r)&&t.push([r,a,n])}),t}function Ce(){if(!l.sourceImageData)return;const t=l.sourceImageData.width,o=l.sourceImageData.height,r=l.sourceImageData.data,a=new Uint8ClampedArray(r.length),n=je(),i={};for(let s=0;s<r.length;s+=4){const p=r[s],h=r[s+1],m=r[s+2];if(r[s+3]===0){a[s]=0,a[s+1]=0,a[s+2]=0,a[s+3]=0;continue}const[w,g,k]=n.length?Ot(p,h,m,n):[p,h,m];a[s]=w,a[s+1]=g,a[s+2]=k,a[s+3]=255;const y=`${w},${g},${k}`;i[y]=(i[y]||0)+1}l.processedCanvas||(l.processedCanvas=document.createElement("canvas"),l.processedCtx=l.processedCanvas.getContext("2d")),l.processedCanvas.width=t,l.processedCanvas.height=o;const d=new ImageData(a,t,o);l.processedCtx.putImageData(d,0,0),l.lastColorCounts=i}function te(){const t=Number(l.zoom)||1,o=l.processedCanvas;if(!o)return;const r=Math.max(1,Math.round(o.width*t)),a=Math.max(1,Math.round(o.height*t));l.previewCanvas.width=r,l.previewCanvas.height=a;const n=l.previewCtx;n.clearRect(0,0,r,a),n.imageSmoothingEnabled=!1,n.drawImage(o,0,0,o.width,o.height,0,0,r,a),n.imageSmoothingEnabled=!0}function oe(){if(!l.sourceImageData){l.meta.textContent="";return}const t=l.sourceImageData.width,o=l.sourceImageData.height,r=Object.keys(l.lastColorCounts||{}).length,a=l.isStale?"pending recalculation":"up to date";l.meta.textContent=`Size: ${t}\xD7${o} | Zoom: ${l.zoom.toFixed(2)}\xD7 | Colors: ${r} | Status: ${a}`}function Je(){if(!l||!l.lastColorCounts)return;const t=document.getElementById("op-cc-color-list");if(!t)return;const o=l.lastColorCounts,r=Object.entries(o).sort(([,n],[,i])=>i-n),a=new Set(re.map(([n,i,d])=>`${n},${i},${d}`));if(t.innerHTML="",r.length===0){t.innerHTML='<div class="op-muted" style="text-align:center; padding: 12px 0;">No colors in image.</div>';return}for(const[n,i]of r){const d=a.has(n),s=ye[n]||n,p=document.createElement("div");p.className="op-color-list-item"+(d?" premium":""),p.title=`${s} (${n}): ${i} pixels`,p.innerHTML=`
      ...
      `,t.appendChild(p)}}function _t(){l.freeGrid.innerHTML="",l.paidGrid.innerHTML="";for(const[t,o,r]of Se){const a=`${t},${o},${r}`,n=document.createElement("div");n.className="op-cc-cell",n.style.background=`rgb(${t},${o},${r})`,n.title=ye[a]||a,n.dataset.key=a,n.dataset.type="free",l.selectedFree.has(a)&&n.classList.add("active"),n.addEventListener("click",async()=>{l.selectedFree.has(a)?l.selectedFree.delete(a):l.selectedFree.add(a),n.classList.toggle("active",l.selectedFree.has(a)),c.ccFreeKeys=Array.from(l.selectedFree),await E(["ccFreeKeys"]),l.realtime?Ce():l.isStale=!0,te(),oe(),he()}),l.freeGrid.appendChild(n)}for(const[t,o,r]of re){const a=`${t},${o},${r}`,n=document.createElement("div");n.className="op-cc-cell",n.style.background=`rgb(${t},${o},${r})`,n.title=ye[a]||a,n.dataset.key=a,n.dataset.type="paid",l.selectedPaid.has(a)&&n.classList.add("active"),n.addEventListener("click",async()=>{l.selectedPaid.has(a)?l.selectedPaid.delete(a):l.selectedPaid.add(a),n.classList.toggle("active",l.selectedPaid.has(a)),c.ccPaidKeys=Array.from(l.selectedPaid),await E(["ccPaidKeys"]),l.realtime?Ce():l.isStale=!0,te(),oe(),he()}),l.paidGrid.appendChild(n)}he()}function he(){l.freeToggle.textContent=Qe()?"Unselect All":"Select All",l.paidToggle.textContent=et()?"Unselect All":"Select All"}function Qe(){return be.every(t=>l.selectedFree.has(t))}function et(){const t=re.map(([o,r,a])=>`${o},${r},${a}`);return t.every(o=>l.selectedPaid.has(o))&&t.length>0}function tt(t,o){if(t==="free")o?be.forEach(a=>l.selectedFree.add(a)):l.selectedFree.clear(),l.freeGrid.querySelectorAll(".op-cc-cell").forEach(a=>a.classList.toggle("active",o));else{const r=re.map(([a,n,i])=>`${a},${n},${i}`);o?r.forEach(a=>l.selectedPaid.add(a)):l.selectedPaid.clear(),l.paidGrid.querySelectorAll(".op-cc-cell").forEach(a=>a.classList.toggle("active",o))}}let e=null;function Yt(){const t=document.createElement("div");t.className="op-rs-backdrop",t.id="op-rs-backdrop",document.body.appendChild(t);const o=document.createElement("div");o.className="op-rs-modal",o.id="op-rs-modal",o.style.display="none",o.innerHTML=`
